...
export const _clientEventNumber = [
  1, 3, 7, 8, 8, 5, 10, 1, 8, 8, 2, 11, 12, 8, 4, 11, 8, 9, 4, 9, 2, 6, 3, 7,
];
...
export const _clientsCreationDates = [
  `15/03/21 - 08H45`,
  `27/06/22 - 14H20`,
  `02/11/23 - 09H10`,
  `10/01/24 - 16H55`,
...
export const _clients = [
  ...
  `KPMG Côte d'Ivoire`,
  `Bouygues Construction Côte d'Ivoire`,
  `Prosuma`,
  `Banque Atlantique`,
  `SICOR Côte d'Ivoire`,
  `Heineken Côte d'Ivoire`,
  `CGECI (Confédération Générale des Entreprises de Côte d’Ivoire)`,
  `L'Oréal Afrique de l'Ouest`,
  `Diageo Guinness Côte d'Ivoire`,
  `Airtel Africa`,
...
export const _eventDescriptions = [
  ...
  `Festival de musique en plein air offrant une expérience immersive avec plusieurs scènes présentant des artistes locaux et internationaux dans divers genres musicaux. L'événement comprend des zones de restauration, des stands d'artisanat et des espaces de détente pour créer une atmosphère festive unique.`,

  `Conférence de premier plan réunissant les experts et visionnaires du secteur technologique pour partager les dernières innovations et tendances émergentes. Les participants peuvent assister à des présentations passionnantes, des ateliers pratiques et des sessions de networking avec les leaders de l'industrie.`,

  `Soirée élégante de collecte de fonds combinant un dîner gastronomique raffiné avec un programme de divertissement de haute qualité. L'événement soutient des causes caritatives importantes tout en offrant une expérience mémorable aux donateurs et invités.`,

  `Exposition mettant en valeur les œuvres d'artistes émergents et établis dans un cadre inspirant propice à la découverte artistique. Les visiteurs peuvent admirer des créations diverses allant de la peinture à la sculpture en passant par les installations multimédias.`,

  `Session de formation intensive conçue pour développer les compétences professionnelles clés des employés à travers des exercices pratiques et des mises en situation. Le programme combine théorie et pratique pour maximiser l'apprentissage et l'engagement des participants.`,

  `Journée dédiée à la sensibilisation et à l'éducation sur la santé, proposant des dépistages gratuits, des consultations avec des professionnels et des ateliers sur le bien-être. Les visiteurs peuvent obtenir des conseils personnalisés et découvrir des ressources locales pour améliorer leur santé.`,

  `Soirée dynamique où les startups prometteuses présentent leurs projets innovants devant un panel d'investisseurs et d'experts du secteur. Les entrepreneurs ont l'opportunité de gagner des financements et de précieux retours pour développer leurs initiatives.`,

  `Compétition sportive rassemblant les meilleurs athlètes de la région dans diverses disciplines pour des confrontations passionnantes. L'événement attire supporters et familles dans une ambiance festive célébrant l'excellence sportive.`,

  `Célébration littéraire marquant la sortie d'un nouvel ouvrage, avec lectures par l'auteur et séances de dédicaces dans une atmosphère conviviale. Les passionnés de lecture peuvent échanger avec l'écrivain et découvrir les coulisses de son travail créatif.`,

  `Projection exclusive d'un film très attendu en présence de l'équipe artistique, suivie d'une séance de questions-réponses avec les créateurs. L'événement offre aux cinéphiles une expérience unique pour découvrir les dessous du film et rencontrer ses artisans.`,

  `Rencontre professionnelle facilitant les connexions entre acteurs d'un même secteur dans un cadre décontracté propice aux échanges. Les participants peuvent développer leur réseau, explorer des opportunités de collaboration et partager leurs expériences.`,

  `Marché festif réunissant artisans et créateurs locaux proposant des créations uniques et cadeaux originaux pour les fêtes. Les visiteurs découvrent un large choix d'articles faits main dans une ambiance chaleureuse et conviviale.`,

  `Programme d'activités et conférences sensibilisant aux enjeux environnementaux et présentant des solutions concrètes pour un mode de vie plus durable. Les participants apprennent des gestes écologiques à travers des démonstrations et ateliers pratiques.`,

  `Célébration grandiose marquant le passage à la nouvelle année avec musique live, danse, cocktails raffinés et compte à rebours festif. La soirée culminera avec un magnifique feu d'artifice à minuit dans une ambiance électrique.`,

  `Présentation officielle des dernières innovations d'une entreprise devant un public de clients, partenaires et médias dans un cadre moderne et immersif. L'événement met en scène les nouveaux produits à travers des démonstrations spectaculaires et interactives.`,

  `Festival célébrant la diversité culturelle à travers performances artistiques, danses traditionnelles, cuisine du monde et artisanat local. Les visiteurs voyagent à travers différentes cultures en découvrant leurs traditions, saveurs et expressions artistiques uniques.`,

  `Salon présentant les dernières avancées scientifiques et technologiques à travers démonstrations interactives et conférences captivantes. Les visiteurs peuvent expérimenter les innovations de demain et échanger avec des chercheurs passionnés.`,

  `Cérémonie prestigieuse récompensant l'excellence et les réussites marquantes de l'année dans un secteur d'activité. La soirée de gala met à l'honneur les lauréats à travers un programme élégant mêlant remises de prix et moments de divertissement.`,

  `Défilé de mode présentant les dernières collections de créateurs renommés et émergents dans un cadre spectaculaire. L'événement rassemble célébrités, acheteurs et passionnés de mode pour découvrir les tendances de la saison.`,

  `Expérience gastronomique permettant de déguster une sélection de vins fins et mets raffinés dans une ambiance sophistiquée. Les participants découvrent de nouvelles saveurs guidés par des experts passionnés partageant leurs connaissances.`,

  `Programme d'activités en pleine nature combinant défis sportifs, exploration et team-building dans un environnement naturel préservé. Les participants développent leurs compétences d'aventurier tout en créant des liens forts au sein du groupe.`,

  `Rassemblement des leaders et visionnaires du monde des affaires pour partager insights et stratégies sur les défis actuels du leadership. Les participants bénéficient d'interventions inspirantes et d'opportunités uniques de networking entre décideurs.`,

  `Salon spécialisé réunissant tous les prestataires du secteur du mariage pour inspirer et accompagner les futurs mariés dans leurs préparatifs. Les visiteurs découvrent les dernières tendances et peuvent planifier leur événement en rencontrant des professionnels qualifiés.`,
];

export const _eventTypes = [
  `Conférence`,
  `Séminaire`,
  `Workshop`,
  `Forum`,
