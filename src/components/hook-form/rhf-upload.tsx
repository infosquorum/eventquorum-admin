...
import { Upload, UploadBox, UploadAvatar, UploadLogo } from '../upload';
...
// Types
export type RHFUploadLogoProps = UploadProps & {
  name: string;
  slotProps?: {
    wrapper?: BoxProps;
  };
...
// Component
export function RHFUploadLogo({ name, slotProps, ...other }: RHFUploadLogoProps) {
  const { control, setValue } = useFormContext();
