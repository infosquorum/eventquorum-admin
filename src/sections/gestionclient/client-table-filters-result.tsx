...
import { IClientTableFilters } from 'src/types/client';
...
//   );
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={handleReset} sx={sx}>
      ...
      <FiltersBlock label="Keyword:" isShow={!!currentFilters.company_name}>
        <Chip {...chipProps} label={currentFilters.company_name} onDelete={handleRemoveKeyword} />
      </FiltersBlock>
    </FiltersResult>
  );
}
