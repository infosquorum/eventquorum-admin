    ...
    return (
        ...
        >
            <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between' }}>
                <div>
                    <Box sx={{ mb: 3, typography: 'subtitle2' }}>{title}</Box>

                    <Box sx={{ fontSize: 40, lineHeight: 1.50, fontWeight: 700 }}>{fFCFA(total)}</Box>
                    {/* typography: 'h3' */}
                </div>
            ...
            <Chart type="line" series={chart.series} options={chartOptions} sx={{ mt: 15, height: 120 }} />
